...
import { XyoOriginBlockGetter, XyoOriginBlockRepository } from './xyo-origin-block-repository'

export class XyoMemoryBlockRepository implements XyoOriginBlockRepository, XyoOriginBlockGetter {
  ...
  // eslint-disable-next-line require-await
  public async getOriginBlocks(_limit?: number, _offset?: Buffer): Promise<{ items: Buffer[]; total: number }> {
